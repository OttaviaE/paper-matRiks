...
\midrule
{}[Black figures](https://cran.r-project.org/web/packages/matRiks/vignettes/black-figures.html) & \includegraphics[width=1in, height=1in]{black-figures.png} & {}[Flowers figures](https://cran.r-project.org/web/packages/matRiks/vignettes/flowers-figures.html) & \includegraphics[width=1in, height=1in]{flowers.png} & {}[Other figures](https://cran.r-project.org/web/packages/matRiks/vignettes/other-figures.html) & \includegraphics[width=1in, height=1in]{other-figures.png}\\
{}[Circle sections](https://cran.r-project.org/web/packages/matRiks/vignettes/circle-sections.html) & \includegraphics[width=1in, height=1in]{circle-sections.png} & {}[Eight-shaped figures](https://cran.r-project.org/web/packages/matRiks/vignettes/eight-shapes-figures.html) & \includegraphics[width=1in, height=1in]{eight-shapes-figures.png} &  & \includegraphics[width=1in, height=1in]{}\\
{}[Closed figures](https://cran.r-project.org/web/packages/matRiks/vignettes/closed-figures.html) & \includegraphics[width=1in, height=1in]{closed-figures.png} & {}[Lines](https://cran.r-project.org/web/packages/matRiks/vignettes/lines.html) & \includegraphics[width=1in, height=1in]{lines.png} &  & \includegraphics[width=1in, height=1in]{}\\
\bottomrule
\end{tabular}
\end{table}
